    ...
    function n(t) {
        function n(t) {
            if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                for (var u = r.isBorderBox = !(!p || !n[p] || "border-box" !== n[p]), c = 0, d = a.length; d > c; c++) {
                    var f = a[c],
                        l = n[f];
                    l = o(t, l);
                    var y = parseFloat(l);
                ...
                var g = r.paddingLeft + r.paddingRight,
                    ...
                    b = u && h,
                    E = e(n.width);
                E !== !1 && (r.width = E + (b ? 0 : g + w));
                var T = e(n.height);
                return T !== !1 && (r.height = T + (b ? 0 : m + _)), r.innerWidth = r.width - (g + w), r.innerHeight = r.height - (m + _), r.outerWidth = r.width + v, r.outerHeight = r.height + x, r
            }
        }
...
function(t) {
    ...
    var a = t.document,
        h = t.console,
        p = t.jQuery,
        u = function() {}, c = Object.prototype.toString,
...
function(t) {
    function e(t, e, i, n, o, r) {
        ...
        }, s.prototype._setMaxXY = function(t) {
